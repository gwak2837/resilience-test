...
export default class ResilienceTestDocument extends Document {
    ...
    return (
      <Html>
        <Head>
          ...
          <meta name="application-name" content="회복 탄력성 검사" />
          <meta name="theme-color" content={PRIMARY_BACKGROUND_COLOR} />
          <meta name="apple-mobile-web-app-capable" content="yes" />
          <meta name="apple-mobile-web-app-title" content="회복 탄력성 검사" />
